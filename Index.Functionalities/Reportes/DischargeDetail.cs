...
namespace Index.Functionalities.Reportes
{
    public class DischargeDetail
    {
        ...
        public DischargeDetail(String reportpath, String filepath, String username, String customername, String url)
        {
        ...
        public String Generate(Int32? IdCustomer, Int32? IdAccount, DateTime? StartDate, DateTime? EndDate, Boolean? GetTransmited, String FileHeaderList, String FileDetailList)
        {
            ...
            List<Commons.Reports.DischargeDetail> data = new List<Commons.Reports.DischargeDetail>();
            ...
            IRestResponse WSR = Task.Run(() => apiClient.getJArray("Reporte/DetalleDescargo", "IdCustomer=" + IdCustomer
                                                                    + "&IdAccount=" + IdAccount
            ...
            {
                data = JArray.Parse(WSR.Content).ToObject<List<Commons.Reports.DischargeDetail>>();
            }
            DataSet ds = new DataSet();
            ds.Tables.Add(Data.ListToDataTable<Commons.Reports.DischargeDetail>(data));

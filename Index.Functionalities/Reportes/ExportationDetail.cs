...
{
    public class ExportationDetail
    {
        ...
        public ExportationDetail(String reportpath, String filepath, String username, String customername, String url)
        {
        ...
        public String Generate(Int32? IdCustomer, Int32? IdAccount, DateTime? StartDate, DateTime? EndDate, Boolean? GetTransmited, String FileHeaderList, String FileDetailList)
        {
            ...
            List<Commons.Reports.ExportationDetail> data = new List<Commons.Reports.ExportationDetail>();
            ...
            IRestResponse WSR = Task.Run(() => apiClient.getJArray("Reporte/DetalleExportacion", "IdCustomer=" + IdCustomer
                                                                    + "&IdAccount=" + IdAccount
            ...
            {
                data = JArray.Parse(WSR.Content).ToObject<List<Commons.Reports.ExportationDetail>>();
            }
            DataSet ds = new DataSet();
            ds.Tables.Add(Data.ListToDataTable<Commons.Reports.ExportationDetail>(data));

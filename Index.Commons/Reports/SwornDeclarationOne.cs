...
namespace Index.Commons.Reports
{
    public class SwornDeclarationOne
    {
        ...
        public Decimal? V_Suspenso_Formula { get; set; }
        public Decimal? V_IVA_Formula { get; set; }
        public Decimal? V_Cantidad_Formula { get; set; }
        public Decimal? V_Costo_Cif_Formula { get; set; }

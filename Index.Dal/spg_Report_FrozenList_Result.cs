...
namespace Index.Dal
{
    ...
    public partial class spg_Report_FrozenList_Result
    {
        ...
        public Nullable<int> Numero_Resolucion { get; set; }
        ...
        public Nullable<decimal> FrozenQuantity { get; set; }
        public Nullable<decimal> Cif_Frozen { get; set; }
        public Nullable<decimal> CifD_Frozen { get; set; }
        public Nullable<decimal> Fob_Frozen { get; set; }
        public Nullable<decimal> FobD_Frozen { get; set; }
        public Nullable<decimal> Iva_Frozen { get; set; }
        public Nullable<decimal> DAI_Frozen { get; set; }
    }
}
